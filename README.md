...
[w3C CSS Validator: 0 errors](https://jigsaw.w3.org/css-validator/validator?uri=https%3A%2F%2Fannickrynne.github.io%2FMarvelBattle%2F&profile=css3svg&usermedium=all&warning=1&vextwarning=&lang=en)

This is the report generated by Lighthouse in DevTools:
![ ](docs/lighthouse.png)
...
# ACCESSIBILITY
I use the WAVE chrome extension to test accessibility. It first showed 5 contrast errors (headings in orange, header and footer). This was fixed by changing a color (see my comments under "Design") an adding opacity. My headings were also wrong: one h4 and no h3. I replace the h4 by a label in the 'Register' section. WAVE is more strict than Lighthouse. 
...
# CREDITS
- Code: I followed 2 free tutorials found online to help me build the game with JavaScript. I borrowed codee and ideas for design from both. The first 'Rock Paper Scissors' was also helpful for the design of the Score-Board in CSS (still a learning curve for me):

   - [Web Tutorial- JavaScript, HTML, CSS - Rock Paper Scissors Game 1h27min](https://www.youtube.com/watch?v=jaVNP3nIAv0)
   - [3 ways to code Rock Paper Scissors in JavaScript, Beginner to Intermediate to Advanced!](https://www.youtube.com/watch?v=RwFeg0cEZvQ&t=17s)
- Content: Written by my husband who is a fan of Marvel movies
- Media: For the graphics (Hulk, and the 3 weapons), I found free images from [PIKPNG](https://www.pikpng.com/aboutus/) and for the large background image of Thor and Loki, this came from [PIXELSTALK](https://www.pixelstalk.net/free-avengers-backgrounds/).
- Acknowledgements: Kasia and my cohort classmates for sharing useful information every day
